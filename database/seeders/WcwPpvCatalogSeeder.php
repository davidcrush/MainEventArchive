...
class WcwPpvCatalogSeeder extends Seeder
{
    private const CAGEMATCH_HTML = 'docs/third-party/cagematch/WCW-PPV.html';

    private const FROM_YEAR = 1990;
    ...
    public function run(): void
    {
        ...
        $html = file_get_contents(base_path(self::CAGEMATCH_HTML));
