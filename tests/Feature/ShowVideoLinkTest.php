...
class ShowVideoLinkTest extends TestCase
{
    ...
    public function test_show_page_includes_youtube_and_netflix_search_targets_for_wwe_ppv(): void
    {
        ...
        $this->get(route('shows.show', $show->slug))
            ...
            ->assertInertia(fn ($page) => $page
                ...
                ->where('show.watch_targets.1.mode', 'search')
                ->where(
                    'show.watch_targets.1.url',
